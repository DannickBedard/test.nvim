...
local constant = require("test.borders.constant")
...
return {
  doubleBorder = require("test.borders.double"),
  simpleBorder = require("test.borders.simple"),
  simpleThickBorder = require("test.borders.thick"),
